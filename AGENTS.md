...
- The app Settings page displays only the App Store-style version (`1.0.N`). Build number and `CalorieCopSourceCommit` remain embedded for diagnostic matching but are not shown in the UI.
